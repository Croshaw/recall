...
public class Theme
{
    public static Theme Dark = new(ColorTranslator.FromHtml("#20222c"), ColorTranslator.FromHtml("#1c1e26"),
    ...
    public Theme(Color background, Color altBackground, Color text, Color altText,
